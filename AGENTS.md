...
- **.NET SDK 10.0.100+** - installed via `dotnet-install.sh --channel 10.0 --quality ga`. The `global.json` specifies `10.0.100` with `rollForward: latestMinor`, so any 10.0.x stable SDK works.
